...
$xtpl = new XTemplate('detail_categories.tpl', NV_ROOTDIR . '/themes/' . $global_config['module_theme'] . '/modules/' . $module_file);
    ...
    foreach ($array_row as $row){
        ...
        if (!empty($row['id'])){
            ...
            while ($row2 = $result2->fetch()){
                ...
                $row['desc_image'] = $row2['desc_image'];
        ...
        $row['url_add_image'] = NV_BASE_ADMINURL . 'index.php?' . NV_LANG_VARIABLE . '=' . NV_LANG_DATA . '&amp;' . NV_NAME_VARIABLE . '=' .$module_name. '&amp;' . NV_OP_VARIABLE .'=img&amp;id_album='.$row['id'];
